...
// New recipes to add sockets to items via the Horadric Cube
{
  const newRecipes = [
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "1 Perfect Gem + Rare Armor -> Socketed Rare Armor 1",
      "numinputs": "2",
      "input1": "tors,rar,nos",
      "input2": "gem4,qty=1",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "2 Perfect Gem + Rare Armor -> Socketed Rare Armor 2",
      "numinputs": "3",
      "input1": "tors,rar,nos",
      "input2": "gem4,qty=2",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "3 Perfect Gem + Rare Armor -> Socketed Rare Armor 3",
      "numinputs": "4",
      "input1": "tors,rar,nos",
      "input2": "gem4,qty=3",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "4 Perfect Gem + Rare Armor -> Socketed Rare Armor 4",
      "numinputs": "5",
      "input1": "tors,rar,nos",
      "input2": "gem4,qty=4",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "1 Perfect Gem + Rare Helm -> Socketed Rare Helm 1",
      "numinputs": "2",
      "input1": "helm,rar,nos",
      "input2": "gem4,qty=1",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "2 Perfect Gem + Rare Helm -> Socketed Rare Helm 2",
      "numinputs": "3",
      "input1": "helm,rar,nos",
      "input2": "gem4,qty=2",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "3 Perfect Gem + Rare Helm -> Socketed Rare Helm 3",
      "numinputs": "4",
      "input1": "helm,rar,nos",
      "input2": "gem4,qty=3",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "1 Perfect Gem + Rare Shield -> Socketed Rare Shield 1",
      "numinputs": "2",
      "input1": "shld,rar,nos",
      "input2": "gem4,qty=1",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "2 Perfect Gem + Rare Shield -> Socketed Rare Shield 2",
      "numinputs": "3",
      "input1": "shld,rar,nos",
      "input2": "gem4,qty=2",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "3 Perfect Gem + Rare Shield -> Socketed Rare Shield 3",
      "numinputs": "4",
      "input1": "shld,rar,nos",
      "input2": "gem4,qty=3",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "4 Perfect Gem + Rare Shield -> Socketed Rare Shield 4",
      "numinputs": "5",
      "input1": "shld,rar,nos",
      "input2": "gem4,qty=4",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "1 Perfect Gem + Rare Weapon -> Socketed Rare Weapon 1",
      "numinputs": "2",
      "input1": "weap,rar,nos",
      "input2": "gem4,qty=1",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "2 Perfect Gem + Rare Weapon -> Socketed Rare Weapon 2",
      "numinputs": "3",
      "input1": "weap,rar,nos",
      "input2": "gem4,qty=2",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "3 Perfect Gem + Rare Weapon -> Socketed Rare Weapon 3",
      "numinputs": "4",
      "input1": "weap,rar,nos",
      "input2": "gem4,qty=3",
      "input3": "",
    ...
    },
    {
      "enabled": 1,
      "version": 100,
      "description": "4 Perfect Gem + Rare Weapon -> Socketed Rare Weapon 4",
      "numinputs": "5",
      "input1": "weap,rar,nos",
      "input2": "gem4,qty=4",
      "input3": "",
...
// Book of Skill and Stat Pot items [ItemTypes.txt]
{
  const itemTypeNewEntries = [
    {
  ...
  const itemTypeFilename = 'global\\excel\\itemtypes.txt';
  const itemType = D2RMM.readTsv(itemTypeFilename);
  itemTypeNewEntries.forEach((itemTypeEntry) => {
    itemType.rows.push({
      ...itemTypeEntry,
      "ItemType": itemTypeEntry.itemType,
      "Code": itemTypeEntry.code,
      "Equiv1": itemTypeEntry.equiv1,
      "Repair": itemTypeEntry.repair,
      "Body": itemTypeEntry.body,
      "Throwable": itemTypeEntry.throwable,
      "Reload": itemTypeEntry.reLoad,
      "ReEquip": itemTypeEntry.reEquip,
      "AutoStack": itemTypeEntry.autostack,
      "Normal": itemTypeEntry.normal,
      "Beltable": itemTypeEntry.beltable,
      "MaxSockets1": itemTypeEntry.maxSockets1,
      "MaxSocketsLevelThreshold1": itemTypeEntry.maxSocketsLevelThreshold1,
      "MaxSockets2": itemTypeEntry.maxSockets2,
      "MaxSocketsLevelThreshold2": itemTypeEntry.maxSocketsLevelThreshold2,
      "MaxSockets3": itemTypeEntry.maxSockets3,
      "TreasureClass": itemTypeEntry.treasureClass,
      "Rarity": itemTypeEntry.rarity,
      "VarInvGfx": itemTypeEntry.varInvGfx,
      "StorePage": itemTypeEntry.storePage,
      "*eol": itemTypeEntry.eol,
    });
  });
  D2RMM.writeTsv(itemTypeFilename, itemType);
}

// Book of Skill and Stat Pot items [Misc.txt]
{
  const miscNewEntries = [
    {
      name: "Stat Pot",
      compactsave: 1,
      version: 100,
      ...
      akaraMagicLvl: 255,
      faraMagicLvl: 255,
      locationysanderMagicLvl: 255,
      drognanMagicLvl: 255,
      hratliMagicLvl: 255,
      alkorMagicLvl: 255,
      ormusMagicLvl: 255,
      elzixMagicLvl: 255,
      ashearaMagicLvlMagicLvl: 255,
      cainMagicLvl: 255,
      halbuMagicLvl: 255,
      malahMagicLvl: 255,
      larzukMagicLvl: 255,
  ...
  const miscFilename = 'global\\excel\\misc.txt';
  const misc = D2RMM.readTsv(miscFilename);
  miscNewEntries.forEach((miscEntry) => {
    misc.rows.push({
      ...miscEntry,
      "name": miscEntry.name,
      "compactsave": miscEntry.compactsave,
      "version": miscEntry.version,
      "level": miscEntry.level,
      "ShowLevel": miscEntry.showLevel,
      "levelreq": miscEntry.levelReq,
      "rarity": miscEntry.rarity,
      "spawnable": miscEntry.spawnable,
      "speed": miscEntry.speed,
      "nodurability": miscEntry.nodurability,
      "cost": miscEntry.cost,
      "code": miscEntry.code,
      "alternategfx": miscEntry.alternategfx,
      "namestr": miscEntry.namestr,
      "component": miscEntry.component,
      "invwidth": miscEntry.invwidth,
      "invheight": miscEntry.invheight,
      "hasinv": miscEntry.hasInv,
      "gemsockets": miscEntry.gemSockets,
      "gemapplytype": miscEntry.gemapplytype,
      "flippyfile": miscEntry.flippyfile,
      "invfile": miscEntry.invfile,
      "Transmogrify": miscEntry.transmogrify,
      "TMogType": miscEntry.tMogType,
      "useable": miscEntry.Useable,
      "type": miscEntry.type,
      "dropsound": miscEntry.dropsound,
      "dropsfxframe": miscEntry.dropsfxframe,
      "usesound": miscEntry.usesound,
      "unique": miscEntry.unique,
      "transparent": miscEntry.transparent,
      "transtbl": miscEntry.transtbl,
      "lightradius ": miscEntry.lightradius,
      "belt": miscEntry.belt,
      "autobelt": miscEntry.autobelt,
      "stackable": miscEntry.stackable,
      "minstack": miscEntry.minstack,
      "maxstack": miscEntry.maxstack,
      "spawnstack": miscEntry.spawnstack,
      "missiletype": miscEntry.missiletype,
      "spellicon": miscEntry.spellicon,
      "pSpell": miscEntry.pSpell,
      "stat1": miscEntry.stat1,
      "calc1": miscEntry.calc1,
      "spelldesc": miscEntry.spelldesc,
      "spelldescstr": miscEntry.spelldescstr,
      "spelldescstr2": miscEntry.spelldescstr2,
      "spelldesccolor": miscEntry.spelldesccolor,
      "durwarning": miscEntry.durwarning,
      "qntwarning": miscEntry.qntwarning,
      "gemoffset": miscEntry.gemoffset,
      "BetterGem": miscEntry.betterGem,
      "bitfield1": miscEntry.bitfield1,
      "CharsiMagicLvl": miscEntry.charsiMagicLvl,
      "GheedMagicLvl": miscEntry.gheedMagicLvl,
      "AkaraMagicLvl": miscEntry.akaraMagicLvl,
      "FaraMagicLvl": miscEntry.faraMagicLvl,
      "LysanderMagicLvl": miscEntry.locationysanderMagicLvl,
      "DrognanMagicLvl": miscEntry.drognanMagicLvl,
      "HratliMagicLvl": miscEntry.hratliMagicLvl,
      "AlkorMagicLvl": miscEntry.alkorMagicLvl,
      "OrmusMagicLvl": miscEntry.ormusMagicLvl,
      "ElzixMagicLvl": miscEntry.elzixMagicLvl,
      "AshearaMagicLvl": miscEntry.ashearaMagicLvlMagicLvl,
      "CainMagicLvl": miscEntry.cainMagicLvl,
      "HalbuMagicLvl": miscEntry.halbuMagicLvl,
      "MalahMagicLvl": miscEntry.malahMagicLvl,
      "LarzukMagicLvl": miscEntry.larzukMagicLvl,
      "AnyaMagicLvl": miscEntry.anyaMagicLvl,
      "JamellaMagicLvl": miscEntry.jamellaMagicLvl,
      "Transform": miscEntry.transform,
      "InvTrans": miscEntry.invTrans,
      "SkipName": miscEntry.skipName,
      "NightmareUpgrade": miscEntry.nightmareUpgrade,
      "HellUpgrade": miscEntry.hellUpgrade,
    });
  });
  D2RMM.writeTsv(miscFilename, misc);
}
